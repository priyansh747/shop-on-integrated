...
public class CreateOrEditUserDuplicate extends BaseTest2 {

	public static void startTest() {
		BaseTest.startTest();
		test = report.startTest("Duplicate Details TestCase");
	}
	...
	public void Login() throws Exception {
		...
		ScreenShot ss1=new ScreenShot(super.driver,"CreateOrEditUserDuplicate");
		ss1.cleanFolder();
		...
		Thread.sleep(2000);
		e=driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[1]/ul/li[3]"));
		e.click();
		e=driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div[2]/div/ul/li[1]"));
		e.click();
		e=driver.findElement(By.id("create-user-link"));
		...
		driver.findElement(By.id("groups6")).click();
		driver.findElement(By.id("groups7")).click();
		select =new Select(driver.findElement(By.id("question1")));
		select.selectByIndex(0);
		e=driver.findElement(By.id("answer1"));
		e.sendKeys(")*&#_!(");
		select =new Select(driver.findElement(By.id("question2")));
		...
		{
			ss1.capture();
			test.log(LogStatus.FAIL, test.addScreenCapture("C:\\Users\\Lenovo\\Automation Testing\\com.ShopOn\\src\\test\\resources\\CreateOrEditUserDuplicate\\CreateOrEditUserDuplicate1.png"));
			test.log(LogStatus.FAIL, "Duplicate USER ADDED TO DATABASE!! FAILED TEST CASE");
		...
		{assert(true);
		test.log(LogStatus.PASS, "Duplicate USER NOT ADDED!");
		}
	}
	catch(Exception E)
		{assert(true);
